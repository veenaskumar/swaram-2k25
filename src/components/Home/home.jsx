...
function Home() {
  ...
  return (
    <div >
      <div id="home" className="home-SCC  min-w-[100%] md:h-[100vh] sm:h-[80vh]  ">
        <div className="home-section-Rpp bg-fixed  min-w-[100%]  ">
          <div className="auto-group-rk2v-NBe  min-w-[100%] sm:h-[10px]  ">
            ...
            <div>
            { width<=430 ?
            <div className="crazy-non-stop-music-jpp   sm:text-wrap w-[100%] sm:w-[100%] sm:right-[5%] sm:top-[-6%] absolute  top-27.2   text-[20px] sm:pt-[-100px]font-semibold text-white capitalize  sm:flex " id="type-text">
            ...
            <div className="details-3ac absolute  md:left-12.4 top-49.1 w-12.7 h-9.8  sm:min-w-[100%] sm:mt-[-100px]  md:pl-[12.4rem] sm:flex sm:flex-col sm:justify-center flex flex-col gap-[1rem] ">
              ...
              <IoLocationSharp size={28} color="red" className=" mb-[0.8rem] "/>
              ...
              <FaRegCalendarDays size={20} color="red" className=" mb-[1rem] ml-[0.5rem]" />
